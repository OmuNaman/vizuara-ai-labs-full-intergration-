// vizuara-ai-learning-lab-main/src/components/modules/self-attention/components/workflow/CalculationNode.tsx
...
export function CalculationNode({ data, id }: CalculationNodeProps) {
  ...
  }, [data.disabled, data.expectedMatrix, id]); // Added id to dependencies
  ...
  return (
    ...
    >
      <div className={`p-4 ${data.disabled ? "pointer-events-none" : ""}`}>
        ...
        >
          <div
            className={`text-lg font-mono ${ // Changed font-family back to mono from handwritten
